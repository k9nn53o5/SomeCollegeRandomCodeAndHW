...
int main(){
	...
	while(scanf("%d",&n) != EOF){
		...
		/*
		moveABlock2BBlockTop(ptr2Blocks,ptr2IndexH,2,0,n);
		moveABlock2BBlockTop(ptr2Blocks,ptr2IndexH,1,0,n);
		blockAbovePutThemBack(ptr2Blocks,ptr2IndexH,0,n);
		moveABlock2BBlockTop(ptr2Blocks,ptr2IndexH,4,0,n);

		moveAontoB(ptr2Blocks,ptr2IndexH,0,3,n);
		*/
		/*
		pileAoverB(ptr2Blocks,ptr2IndexH,0,1,n);
		pileAoverB(ptr2Blocks,ptr2IndexH,2,3,n);
		moveAontoB(ptr2Blocks,ptr2IndexH,1,3,n);
		*/
		/*
		moveAontoB(ptr2Blocks,ptr2IndexH,9,1,n);
		moveAoverB(ptr2Blocks,ptr2IndexH,8,1,n);
		moveAoverB(ptr2Blocks,ptr2IndexH,7,1,n);
		moveAoverB(ptr2Blocks,ptr2IndexH,6,1,n);
		pileAoverB(ptr2Blocks,ptr2IndexH,8,6,n);
		pileAoverB(ptr2Blocks,ptr2IndexH,8,5,n);
		moveAoverB(ptr2Blocks,ptr2IndexH,2,1,n);
		moveAoverB(ptr2Blocks,ptr2IndexH,4,9,n);
		*/
		//moveABlock2BBlockTop(ptr2Blocks,ptr2IndexH,0,4,n);
		/*
		   printIndex(ptr2Blocks,ptr2IndexH,0);
		*/
		/*
		int i,j;
		for(i=0;i<24;i++){
